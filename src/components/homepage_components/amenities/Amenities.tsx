            ...
            <div className="w-full h-fit  flex flex-col lg:flex-row justify-center items-center gap-5">
                ...
                <div className="image w-full h-full flex-1 flex justify-center items-center gap-6">
                    <div className="flex flex-col gap-10">
                        ...
                        <p className="text-base text-justify md:text-xl font-light">
                            Experience unparalleled comfort and serenity at <strong>Aquaa Homes</strong>! Whether you're seeking relaxation, a quiet escape, or quality time with loved ones, our villa is thoughtfully designed to offer a perfect blend of elegance and convenience — all tucked away at <strong>L2,3, Jabo Majra Road, near PKR Jain Vatika School</strong>. Discover a truly unforgettable stay in every moment.
                        </p>
